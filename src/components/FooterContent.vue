...
<template>
  <footer class="px-14 pb-14 pt-10 bg-x-black">
    ...
    <div class="w-full h-[256px] flex-col bg-white bg-opacity-5 p-10 flex justify-center items-center gap-4 mb-10 overflow-hidden md:flex-row">
        <p class="text-white text-2xl font-bold w-[562px] lg:text-4xl">Subscribe to our news letter to get latest updates and news</p>
