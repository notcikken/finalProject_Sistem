...
<template>
  <MainLayout>
    <main class="min-w-screen min-h-screen overflow-x-hidden">
      <!-- Hero -->
      ...
      <section class="bg-white px-[80px] py-[64px]">
        ...
        <div class="bg-x-lightgrey p-[80px] flex justify-between gap-[80px]">
          <div class="w-[50%] flex flex-col gap-4">
            ...
            <a href="/read" class="text-x-yellow text-[18px] font-bold leading-[32px] hover:text-x-black transition duration-200 ease-in-out">Read More ></a>
          </div>
          <div class="w-[50%] flex flex-col gap-4">
      ...
      <!-- Category -->
      <section class="flex flex-col gap-8 bg-white px-[80px] py-[64px]">
      ...
      <!-- Special Post -->
      <section class="bg-white px-[80px] py-[128px]">
