    ...
    <main class="w-full h-full overflow-x-hidden">
      ...
      <section class="bg-wgite p-[80px] flex justify-between items-start gap-4">
        <article class="flex flex-col gap-8 w-[70%]">
          ...
          <div class="flex justify-between items-center gap-8">
            <img class="w-[294px] h-[312px] object-cover" src="@/assets/images/misc/two-woman-in-erase-board.png" alt="Two woman in erase board">
            <div class="flex flex-col gap-4">
              <p class="text-x-yellow font-semibold leading-[20px] tracking-[3px]">BUSINESS</p>
              <h2 class="text-x-black text-4xl font-bold tracking-[-2px] leading-[48px]">
                Top 6 free website mockup tools 2022
          ...
          <div class="flex flex-col gap-10">
            <div class="flex flex-col gap-10">
              ...
              <div class="flex flex-col gap-6">
                ...
                <div class="h-[96px] border-[1.5px] border-[#C1C1C1] p-6 flex items-center gap-4 hover:bg-x-blue hover:border-x-blue hover:cursor-pointer transition duration-200 ease-in-out group">
                  <div class="w-[48px] h-[48px] bg-x-lightyellow rounded flex items-center justify-center">
            ...
            <div class="flex flex-col gap-8">
              ...
              <div class="flex flex-wrap items-center justify-between gap-4">
                <button class="border-x-mediumgrey border-2 rounded-full font-bold text-sm text-x-black leading-[32px] px-[38px] py-[8px]">
                  Business
                </button>
                <button class="border-x-mediumgrey border-2 rounded-full font-bold text-sm text-x-black leading-[32px] px-[38px] py-[8px]">
                  Experience
                </button>
                <button class="border-x-mediumgrey border-2 rounded-full font-bold text-sm text-x-black leading-[32px] px-[32px] py-[8px]">
                  Screen
                </button>
                <button class="border-x-mediumgrey border-2 rounded-full font-bold text-sm text-x-black leading-[32px] px-[48px] py-[8px]">
                  Technology
                </button>
                <button class="border-x-mediumgrey border-2 rounded-full font-bold text-sm text-x-black leading-[32px] px-[54px] py-[8px]">
                  Marketing
                </button>
                <button class="border-x-mediumgrey border-2 rounded-full font-bold text-sm text-x-black leading-[32px] px-[38px] py-[8px]">
                  Life
